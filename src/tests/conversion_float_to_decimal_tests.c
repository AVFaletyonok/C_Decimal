...
START_TEST(test_1) {
  ...
  decimal dec_initial = {{0x0, 0x6, 0x5, 0x0}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
  int expected_error_code = 0;
  error_code = from_float_to_decimal(initial_float, &dec_initial);
  ck_assert_int_eq(error_code, expected_error_code);
  from_decimal_to_float(dec_initial, &res_float);
...
START_TEST(test_2) {
  float initial_float = -6.234543;
  decimal dec_initial = {{0x0, 0x0, 0x0, 0x0}};
  decimal dec_expected = {{0x5f21af, 0x0, 0x0, 0x80060000}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
  ...
  error_code = from_float_to_decimal(initial_float, &dec_initial);
  ck_assert_int_eq(error_code, expected_error_code);
  ck_assert_mem_eq(&dec_expected, &dec_initial, sizeof(decimal));
  from_decimal_to_float(dec_initial, &res_float);
  sprintf(res, "%.7e", res_float);
  sprintf(expected, "%.7e", initial_float);
  ck_assert_str_eq(res, expected);
...
START_TEST(test_3) {
  ...
  decimal dec_initial = {{0x0, 0x0, 0x0, 0x0}};
  decimal dec_expected = {{0x1e240, 0x0, 0x0, 0x60000}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
...
START_TEST(test_zero) {
  ...
  decimal dec_initial = {{0x6, 0x3, 0x1, 0x8}};
  decimal dec_expected = {{0x0, 0x0, 0x0, 0x0}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
...
START_TEST(test_minus_zero) {
  float initial_float = -0.0;
  decimal dec_initial = {{0x6, 0x3, 0x1, 0x8}};
  decimal dec_expected = {{0x0, 0x0, 0x0, 0x80000000}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
...
START_TEST(test_too_low_float) {
  ...
  decimal dec_initial = {{0x4, 0x1, 0x2, 0x3}};
  decimal dec_expected = {{0x0, 0x0, 0x0, 0x0}};
  float res_float = 0;
  int error_code = -1;
  int expected_error_code = 1;
...
START_TEST(test_5) {
  ...
  decimal dec_initial = {{0x6, 0x3, 0x1, 0x8}};
  decimal dec_expected = {{0x1, 0x0, 0x0, 0x60000}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
...
START_TEST(test_6) {
  ...
  decimal dec_initial = {{0x6, 0x3, 0x1, 0x8}};
  decimal dec_expected = {{0x12d4e8, 0x0, 0x0, 0x40000}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
...
START_TEST(test_7) {
  ...
  decimal dec_initial = {{0x0, 0x0, 0x0, 0x0}};
  decimal dec_expected = {{545706800, 0x0, 0x0, 0x0}};
  float res_float = 0;
  char res[32] = {0};
  char expected[32] = {0};
  int error_code = -1;
...
START_TEST(test_8) {
  ...
  int error_code = -1;
  int expected_error_code = 1;
  error_code = from_float_to_decimal(initial_float, ptr);
  ck_assert_int_eq(error_code, expected_error_code);
}
END_TEST
